...
Una variable aleatoria es una función, pero no cualquier función es una variable aleatoria. En dicha función, lo que va cambiando es el recorrido, pero no el dominio (que está en $\Omega$)
...
Esto me permite calcular $P$ para cualquier intervalito que se quiera definir.
