...
(\#eq:test-hipotesis-una-cola)
\end{equation}

Sabemos que si la media de $\mu_0 => \bar{X}~NORMAL(\mu_0, \sigma^2/n)$ entonces:

\begin{equation}
$\left (\frac{-k}{\sigma/\sqrt{n}} < \frac{\bar{X} - \mu_0}{\sigma/\sqrt{n}} $
\end{equation}
...
hist(unlist(lapply(1:1000, FUN = function(x) mean(runif(2)))), 10,
     main="", xlab="Mean")
```
